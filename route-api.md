...
| `PATCH` | `/pickups/reorder` | Pengurus, Petugas | **Urutan antrean penjemputan (R23):**<br>**Body:** `{ "ids": [3, 1, 2] }` — array id berurutan sesuai posisi baru; id yang tidak dikirim mempertahankan urutannya. Tiket baru otomatis masuk ekor antrean. | `200 OK`<br>`reordered` |
